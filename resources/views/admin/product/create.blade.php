                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <button style="background-color:#307B40" class="btn btn-success mr-1 btn-submit"
                                type="submit"><i class="fa fa-paper-plane"></i>
                                SIMPAN</button>
                            <button style="background-color:#DB8A23" class="btn btn-warning btn-reset" type="reset"><i
