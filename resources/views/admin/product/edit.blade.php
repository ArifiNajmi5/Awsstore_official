            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.product.update', $product->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="variations">
                                        ...
                                        @foreach ($variations as $variation)
                                            <input type="text" name="variations[]" class="form-control" style="margin-bottom: 8px" value="{{ $variation }}" placeholder="variasi">
                                        @endforeach
                                    </div>
                                    {{--  --}}
                        ...
                        <button style="background-color:#307B40" class="btn btn-success mr-1 btn-submit" type="submit"><i class="fa fa-paper-plane"></i>
                            UPDATE</button>
                        <button style="background-color:#DB8A23" class="btn btn-warning btn-reset" type="reset"><i class="fa fa-redo"></i> RESET</button>
